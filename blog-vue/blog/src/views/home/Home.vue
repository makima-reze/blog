...
export default {
  ...
  data: function() {
    return {
      ...
      cover:{
      backgroundImage: "url(" + require("../../assets/fig/background.png") + ")",
  ...
  computed: {
    ...
    // cover() {
      ...
      //   }
      // });
    //   return "background: url('../../assets/fig/background.png') center center / cover no-repeat";
    // }
  }
};
</script>
